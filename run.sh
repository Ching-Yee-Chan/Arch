...
python evaluate_wavtokenizer.py --model wavtokenizer --device cuda \
    --max_epochs 200 --verbose --tsv_logging_file results/wavtokneizer.tsv \
    --n_iters 1 --data_config_file configs/data_config.json \
    --enabled_datasets medleydb esc50 us8k fsd50k vivae

# slurp audio_mnist fma_small magna_tag_a_tune irmas